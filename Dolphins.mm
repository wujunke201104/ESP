...
static long gWorld(){
    ...
    if ([BundID containsString:@"ig"]) {
        gWorldaddr = 0x10282a858;
        gWorldData = 0x10992a6e0;
    } if ([BundID containsString:@"kr"]) {
        gWorldaddr = 0x1029eb938;
        gWorldData = 0x109b27ee0;
    }if ([BundID containsString:@"rekoo"]) {
        gWorldaddr = 0x1029c2d60;
        gWorldData = 0x109b01d60;
    }if ([BundID containsString:@"vn"]) {
        gWorldaddr = 0x1027912a0;
        gWorldData = 0x109820460;
    }if ([BundID containsString:@"imobile"]) {
        gWorldaddr = 0x102050A28;
        gWorldData = 0x108CC9B48;
    }
    return reinterpret_cast<long(__fastcall*)(long)>((long)_dyld_get_image_vmaddr_slide(1) + gWorldaddr)((long)_dyld_get_image_vmaddr_slide(1) + gWorldData);
}
...
static long gName(){
    ...
    NSString *BundID = [infoDictionary objectForKey:@"CFBundleIdentifier"];
    if ([BundID containsString:@"ig"]) {
        gNameaddr = 0x1044dd6ec;
        gNameData = 0x10953ecd0;
    } if ([BundID containsString:@"kr"]) {
        gNameaddr = 0x10469e9ac;
        gNameData = 0x10973c250;
    }if ([BundID containsString:@"rekoo"]) {
        gNameaddr = 0x104675bf4;
        gNameData = 0x1097160d0;
    }if ([BundID containsString:@"vn"]) {
        gNameaddr = 0x104444134;
        gNameData = 0x109434ad0;
    }if ([BundID containsString:@"imobile"]) {
        gNameaddr = 0x1039D9AF8;
        gNameData = 0x10804C670;
    }
    return  reinterpret_cast<long(__fastcall*)(long)>((long)_dyld_get_image_vmaddr_slide(1) + gNameaddr)((long)_dyld_get_image_vmaddr_slide(1) + gNameData);
}
